...
def finalResult(content, filename):
...
def main():
    trainSet = initData("train.txt")
    testDomainName, testFeatureSet = testingData("test.txt")
    featureMatrix = []
    labelList = []
